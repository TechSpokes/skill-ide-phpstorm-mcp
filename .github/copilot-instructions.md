...
Run `npm run validate` after changes. Run `npm run package -- v0.0.0` when changing packaging or release behavior.

Use `docs/RELEASING.md` for release workflow questions.
